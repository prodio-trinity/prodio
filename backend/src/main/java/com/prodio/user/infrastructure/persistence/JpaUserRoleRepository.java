...
import com.prodio.user.application.UserRoleRepository;
...
class JpaUserRoleRepository implements UserRoleRepository {
    ...
    public void assignDefaultRole(long userId) {
        ...
        UserRoleEntity defaultRole = roleCodes.findByCode(UserRole.UNREGISTERED_CLIENT)
                .orElseThrow(() -> new IllegalStateException("기본 UNREGISTERED_CLIENT 역할 코드가 없습니다."));
