...
public record OrderStatusView(
    ...
    public static OrderStatusView create(long orderId, long clientId, String clientName,
            long productId, String productName, int quantity, long totalAmount,
            LocalDate dueDate, OffsetDateTime orderCreatedAt) {
        return new OrderStatusView(null, orderId, clientId, clientName, productId, productName,
                quantity, totalAmount, dueDate, OrderViewStatus.PENDING, false, null,
